...
export default function UpdatePasswordPage() {
  ...
  return (
    <div className="min-h-screen w-full flex items-center justify-center p-4 bg-cover bg-center bg-[url('/images/backgrounds/mountain-mobile.png')] sm:bg-[url('/images/backgrounds/landscape-hero.png')]">
