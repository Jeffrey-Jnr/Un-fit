    ...
    <section ref={container} id="sample" className="bg-white relative overflow-hidden flex flex-col">
      <div className="max-w-7xl mx-auto w-full grid grid-cols-1 lg:grid-cols-2 gap-0 md:gap-8 lg:gap-24 items-center pt-10 lg:pt-8 pb-8 lg:pb-12 px-6 lg:px-12 relative z-10">
        ...
        <div className="sample-image order-2 lg:order-1 w-full flex flex-col items-center justify-center -mt-8 md:mt-0 opacity-0 will-change-transform">
           ...
           <a href="#" className="inline-flex lg:hidden items-center justify-center gap-3 bg-[#ea580c] hover:bg-orange-700 text-white px-8 py-4 w-auto rounded-full font-normal md:font-medium text-[17px] md:text-lg hover:scale-105 transition-transform duration-300">
             <Download size={20} />
        ...
        <div className="sample-text order-1 lg:order-2 flex flex-col items-center lg:items-start lg:pl-8 xl:pl-16">
          ...
          <a href="#" className="hidden lg:inline-flex items-center gap-3 bg-[#ea580c] hover:bg-orange-700 text-white px-8 py-4 rounded-full font-medium text-lg hover:scale-105 transition-transform duration-300 opacity-0 will-change-transform">
            <Download size={20} />
            Download First Chapter
          </a>
        </div>
